...
public class HtmlTable {
	 ...
	 *
	 */
	public HtmlTable(String alignment) {
		tableBody = "<TABLE>";
		heading = false;
	}

	/**
	 *	Class constructor specifying the value of cell padding.
         *@param cp An integer specifying the value of the table's cellpadding attribute
	 *
	 */
