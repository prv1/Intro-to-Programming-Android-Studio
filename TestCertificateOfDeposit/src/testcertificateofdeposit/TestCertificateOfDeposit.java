 ...
 * Phillip Viau
 * 12/04/2015
 * asks user input and assigns it with methods and displays certificate informatino
 */
...
private TestCertificateOfDeposit CertificateOfDeposit;
    ...
    public static void main(String[] args) {
        ...
        TestCertificateOfDeposit customer = new TestCertificateOfDeposit(0,123,"Customer",33.22,now);
        customer.run(2);
        //customer.display();
    ...
    public void run(int r){
        ...
        do{
            ...
            TestCertificateOfDeposit customer = new TestCertificateOfDeposit(getCustNumber(),getCertificate(),getLastName(),getBalance(), now );
            display();
            i++;
        }while(i<r);
    ...
    public TestCertificateOfDeposit(int cNumber, long c, String n, double b, GregorianCalendar iDate){
